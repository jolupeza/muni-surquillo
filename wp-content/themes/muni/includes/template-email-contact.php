          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="bodycopy" align="center" style="color: #484848; font-family: Arial; font-size: 14px; line-height: 18px;">
                Nueva consulta realizada a través del Formulario de Contacto de nuestra Web
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td class="innerpadding bodycontent" style="padding: 30px 50px 30px 50px; background-color: #f7f7f7;">
          <table width="185" align="left" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td class="bodycopy" align="right" style="padding: 10px 10px 10px 10px; font-size: 14px; line-height: 18px; color: #484848; font-family: Arial; font-weight: bold;">Urbanización:</td>
            </tr>
            <tr>
                  ...
                  <table class="col315" align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 315px;">
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="bodycopy" style="padding: 10px 10px 10px 10px; font-size: 14px; line-height: 18px; color: #484848; font-family: Arial;"><?php echo "$name $lastname"; ?></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td class="bodycopy" style="padding: 10px 10px 10px 10px; font-size: 14px; line-height: 18px; color: #484848; font-family: Arial;"><?php echo $address; ?></td>
                          </tr>
                          <tr>
                            <td class="bodycopy" style="padding: 10px 10px 10px 10px; font-size: 14px; line-height: 18px; color: #484848; font-family: Arial;"><?php echo $urba; ?></td>
                          </tr>
                          <tr>
                            <td class="bodycopy" style="padding: 10px 10px 10px 10px; font-size: 14px; line-height: 18px; color: #484848; font-family: Arial;"><?php echo $subject->name; ?></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
